            ...
            <div className="profil">
                ...
                >
                    <section className="section profil__title">
                        <Job />
                        <h3>
                            Disponibilité imédiate dans le Finistere ou en
                            remote
                        </h3>
                        <Loader size={"regular"} />
                    </section>
                    <section className="section profil__school">
                        ...
                        <div className="container__right">
                            <p>
                                Pour démarrer les présentations, je suis curieux
                                de nature et j'ai eu tendance à rechercher des
                                compétences et des connaissances dans divers
                                domaines. <br />
                                L'informatique depuis tout jeunes dans un
                                premier temps. <br />
                                Amusé de logique et de mathematique, j'ai suivis
                                naturellement un{" "}
                                <strong>cursus scientifiques</strong> au lycée
                                avec une derniere année en{" "}
                                <strong>filière ISN</strong> (Informatique et
                                science du numérique | developpement de petits
                                logiciels en Python).
                                <br /> J'ai suivis ces années lycée par 3 années
                                en <strong>licence de droit</strong> avec une
                                spécialisation en droit privé (Droit du travail
                    ...
                    <section className="section profil__work">
                        ...
                        <div className="container__right">
                            <p>
                                Le travail commence dans un salon de café
                                américain, très prisé des freelances et autres
                                entrepreneurs. J'ai nommé{" "}
                                ...
                                <br />
                                En tant que directeur de sites je me suis vu
                                confier la responsabilité de deux magasins où
                                j'y ai appris et affiné ma gestion.
                                <br />
                    ...
                    <section className="section profil__dev">
                        ...
                        <div className="container__right">
                            <p>
                                ...
                                peut ressembler à un 180 degrés (ou un
                                transform: rotate(180deg)) mais finalement ce
                                retour est plutôt cohérent. J'ai eu une fenêtre
                                pour me lancer dans l'apprentisage professionnel
                                du developpement et je l'ai saisis.
                                <br /> D'abord <strong>
                                    HTML/CSS
                                </strong> puis <strong>Javascript</strong> pour
                                enfin me lancer dans un unique framework,{" "}
                                <strong> React JS</strong>
                                . <br /> GitHub et React Redux ne semblent pas
                                être des options, elles ont donc fait partie
                                intégrante de ma formation . <br />
                                Je suis ouvert à tous les langages et toutes les
                                technos, mais il fallait bien se poser sur un
                                premier et l'appronfondir suffisament pour
                                pouvoir, aujourd'hui, me présenter devant vous,
                                avec la volonté serieuse et réelle de
                                travailler.
                                <br />
